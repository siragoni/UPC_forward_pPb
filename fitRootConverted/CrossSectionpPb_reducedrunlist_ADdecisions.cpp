...
void CrossSectionpPb(){
  ...
  Double_t fD           = 0.1;
  Double_t eJPsi[3]     = { 0.167157, 0.179756, 0.15596 };
  // Double_t eJPsi[3]     = { 0.065, 0.065, 0.065 };
  Double_t LUMI         = 7.917604;
  Double_t BR           = 0.05961;
  Double_t NumOfJPsi[3] = { 362.0,  171.0, 188.0  };
  ...
  Double_t y1Error[6]     = { TMath::Sqrt( ( 26.0* 26.0/(362.0*362.0))  )*DSigmaDy[0],
                              TMath::Sqrt( ( 18.0* 18.0/(171.0*171.0))  )*DSigmaDy[1],
                              TMath::Sqrt( ( 19.0* 19.0/(188.0*188.0))  )*DSigmaDy[2],
                              1.3,
                              2.1,
                              1.5
                              };
