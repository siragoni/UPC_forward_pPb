...
void fitJPsiTemplate(const char* AnalysisName, const int selectionFlag, const int selectionFlag2){
  ...
  if      ( selectionFlag == 0 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionSmall0N0NH");
  else if ( selectionFlag == 1 ) {
    if      ( selectionFlag2 == 0 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionRapidityBinsSmall0N0NH_0");
    else if ( selectionFlag2 == 1 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionRapidityBinsSmall0N0NH_1");
  ...
  if        ( selectionFlag == 0 ) {
                               latex->DrawLatex(0.55,0.72,Form("%.1f < y < %.1f",-3.6,  -2.6));
  } else if ( selectionFlag == 1 ) {
    if ( selectionFlag2 == 0 ) latex->DrawLatex(0.55,0.72,Form("%.1f < y < %.1f",-3.6,  -3.1));
    if ( selectionFlag2 == 1 ) latex->DrawLatex(0.55,0.72,Form("%.1f < y < %.1f",-3.1,  -2.6));
  }
  ...
  gPad->SaveAs(Form("pngResults/InvMassSystematics0N0Nsmall_%d_%d.png", selectionFlag, selectionFlag2), "RECREATE");
