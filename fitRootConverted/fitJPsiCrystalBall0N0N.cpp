...
void fitJPsiTemplate(const char* AnalysisName, const int selectionFlag, const int selectionFlag2){
  ...
  if      ( selectionFlag == 0 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistribution0N0NH");
  else if ( selectionFlag == 1 ) {
    if      ( selectionFlag2 == 0 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionRapidityBins0N0NH_0");
    else if ( selectionFlag2 == 1 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionRapidityBins0N0NH_1");
    // else if ( selectionFlag2 == 2 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionRapidityBinsH_2");
  }
  else if ( selectionFlag == 2 ) {
    if      ( selectionFlag2 == 0 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionMoreRapidityBins0N0NH_0");
    else if ( selectionFlag2 == 1 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionMoreRapidityBins0N0NH_1");
    else if ( selectionFlag2 == 2 ) fInvariantMassDistributionH = (TH1F*)listings->FindObject("fInvariantMassDistributionMoreRapidityBins0N0NH_2");
  }
  ...
  latex->DrawLatex(0.55,0.84,"UPC, LHC16s, 0N0N");
  // latex->DrawLatex(0.55,0.78,"#it{p}_{T} < 0.3 GeV/#it{c}");
  if      ( selectionFlag <  7 ) latex->DrawLatex(0.55,0.78,"#it{p}_{T} < 1 GeV/#it{c}");
  ...
  gPad->SaveAs(Form("pngResults/InvMassSystematics0N0N_%d_%d.png", selectionFlag, selectionFlag2), "RECREATE");
