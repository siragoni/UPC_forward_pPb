...
void CrossSectionpPb(){
  ...
  Double_t fD           = 0.1;
  Double_t eJPsi[3]     = { 0.0764003, 0.0822321, 0.0712141 };
  // Double_t eJPsi[3]     = { 0.065, 0.065, 0.065 };
  Double_t LUMI         = 11.919684/*11919.684*/;
  Double_t BR           = 0.05961;
  Double_t NumOfJPsi[3] = { 306,  144, 158  };
  Double_t Starlight[3] = { 17,  12.0, 22.8 };
  ...
  Double_t y1Error[6]     = { TMath::Sqrt( ( 18.0* 18.0/(306.0*306.0))  )*DSigmaDy[0],
                              TMath::Sqrt( ( 17.0* 17.0/(144.0*144.0))  )*DSigmaDy[1],
                              TMath::Sqrt( ( 13.0* 13.0/(158.0*158.0))  )*DSigmaDy[2],
                              1.3,
                              2.1,
                              1.5
                              };
